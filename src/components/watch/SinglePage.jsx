        ...
        <>
          <section className='singlePage'>
            ...
            <div className='container'>
              ...
              <iframe width="1200" height="580" src={item.video} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              <div className='para'>
          ...
          {/* <Upcomming items={items} title='Aval Viligal - Episodes' /> */}
        </>
      ) : (
        "no"
      )}
